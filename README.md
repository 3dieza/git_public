...
# Как исправить последний коммит с помощью Git

## Зачем это нужно?

Иногда после выполнения коммита необходимо внести изменения:
- Добавить забытые файлы
- Исправить сообщение коммита
- Уточнить историю изменений

Git позволяет сделать это с помощью флага `--amend`, который вносит правки в последний коммит без создания нового.

---

## Как дополнить последний коммит?

### Добавление забытых файлов

1. **Убедитесь, что файл в состоянии staged**:
   ```bash
   git add <имя_файла>